...
filelist <- list.files("~/data-Github/psychencode/PEC_TWAS_weights/")
filelist <- filelist[substr(filelist,1,4)=="ENSG"]

file=filelist[1]

load("/Users/lvairus/data-Github/psychencode/PEC_TWAS_weights/ENSG00000273492.wgt.RDat")
load(glue::glue("/PEC_TWAS_weights/{file}")).
