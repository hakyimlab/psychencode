...
# S-PrediXcan Results
Load the psychencode S-PrediXcan association results, and check for significant genes. There are 11,790 genes, and 175 are significant.
```{r}
...
When we plot the intersection of significant genes, we find that there is no gene that is found significant by more than one model.
```{r}
